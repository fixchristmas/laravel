#!/usr/bin/env bash
# Automated PHP deployment script for DMS.
#
...
APP_THUMBNAIL_URL=$5
DASHBOARD_URL=$6
PIPELINE_URL="https://bitbucket.org/dmsgrp/$BITBUCKET_REPO_SLUG/addon/pipelines/home"
COMMIT_URL="https://bitbucket.org/dmsgrp/$BITBUCKET_REPO_SLUG/commits/$BITBUCKET_COMMIT"
            ...
            "attachments": [
                {
                    ...
                    "footer": "DMS Deployment Automation"
                }
            ]
        }'
